export default {
	...
	'Other Sciences': {
		'Who is credited with inventing the first successful airplane?': {
			answer: 'The Wright Brothers', points: 100},
	...
	"Robotics": {
		...
		'In which year was the term "robot" first introduced in Karel Čapek\'s play "R.U.R."?': {
			answer: '1921', points: 400},
		'What does the acronym "LIDAR" stand for in robotics?': {
			answer: 'Light Detection and Ragging', points: 500}
	}
};
