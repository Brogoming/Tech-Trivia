export default {
	'Computer Jargon': {
		...
		'The act of turning off and on a device to fix an issue.': {
			answer: 'What is rebooting or bouncing?',
			points: 200
		},
	...
	'Quantum Computing': {
		...
		'The field of study that combines quantum physics and computer science.': {
			answer: 'What is quantum information science?',
			points: 500
		}
	},
	...
	'Mobile Technology': {
		...
		'The brand of smart fitness trackers owned by Google.': {
			answer: 'What is Fitbit?',
			points: 400
		},
		"Apple's custom chip architecture used in iPhones.": {
			answer: 'What is the A-series chip?',
			points: 500
		}
	},
	Supercomputers: {
		'The term for thousands of interconnected processors working at the same time.': {
			answer: 'What is parallel computing?',
			points: 100
		},
		'Supercomputers are primarily used for this type of calculation-heavy work.': {
			answer: 'What is scientific computing?',
			points: 200
		},
