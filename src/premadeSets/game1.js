export default {
	'Coding Languages': {
		'What language consists only of 1s and 0s?': {
			answer: 'Binary or Machine Learning', points: 100},
		'What programming language is named after the type of coffee from Indonesia?': {
			answer: 'Java', points: 200},
		'What language was based on a previous language called B?': { 
			answer: 'C', points: 300 },
		'What language is named after a British Comedy group?': { 
			answer: 'Python', points: 400 },
	...
	Syntax: {
		'What character indicates the start of a comment in Python?': { 
			answer: '#', points: 100 },
		'Which data structure (in math or in code) does not contain repeat values?': {
			answer: 'Set', points: 200},
		'What character represents the highest single-digit value in hexadecimal?': {
			answer: 'F', points: 300},
		'What is the largest numerical non-decimal data type in Java?': { 
			answer: 'Long', points: 400 },
